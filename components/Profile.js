...
import { Avatar, Box, Button, Grid, GridItem, StackDivider, Text, VStack, List, ListIcon, ListItem } from "@chakra-ui/react";
import {
  RiBuilding4Line,
  RiHomeHeartLine,
  RiStarLine,
...
const Profile = () => {
  ...
  if (session === undefined) return <AuthError title="Not Authorized!" desc="You cannot access this page because you are not logged in."/>
