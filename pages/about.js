        ...
        <Box>
            ...
            <Grid templateColumns='repeat(3, 1fr)' gap={6}>
                <GridItem w='100%' h='60' bg='gray.100' borderRadius='10'>
                    ...
                    <Text fontSize = '2xl' fontWeight='bold' textAlign='center' color='gray.700' p='5'>Provide real data</Text>
                ...
                <GridItem w='100%' h='60' bg='gray.100' borderRadius='10'>
                    ...
                    <Text fontSize = '2xl' fontWeight='bold' textAlign='center' color='gray.700' p='5'>Hold landlords accountable</Text>
                ...
                <GridItem w='100%' h='60' bg='gray.100' borderRadius='10'>
                    ...
                    <Text fontSize = '2xl' fontWeight='bold' textAlign='center' color='gray.700' p='5'>Emphasize transparency</Text>
